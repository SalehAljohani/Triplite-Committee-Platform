...
namespace Triplite_Committee_Platform.Migrations
{
    ...
    [Migration("20240515075022_Schoalrship_CurrentStudy_toScholarshipType")]
    partial class Schoalrship_CurrentStudy_toScholarshipType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Triplite_Committee_Platform.Models.ScholarshipModel", b =>
                {
                    ...
                    b.Property<string>("ScholarshipTypes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
